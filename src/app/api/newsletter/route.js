...
async function sendNewsletterEmail(email) {
  ...
  const mailOptions = {
    from: `"AgriNet" <${process.env.SMTP_USER}>`,
    to: email,
    subject: "Bienvenue à la newsletter AgriNet",
    html: `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
      ...
      <div style="padding: 20px; line-height: 1.5; color: #333333;">
        ...
        <p style="font-size: 16px; font-weight: bold;">L'équipe de AgriNet</p>
      </div>

      <div style="text-align: center; padding-top: 20px; border-top: 1px solid #eee; color: #666; font-size: 12px;">
        <p>© 2025 AgriNet. Tous droits réservés.</p>
      </div>
    </div>
  `,
  };
